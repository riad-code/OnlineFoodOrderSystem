      ...
      <div className="hero min-h-screen bg-base-200">
        <div className="hero-content w-1/2 flex-col md:flex-row">
          <div className="text-center lg:text-left">
            ...
            <p className="py-6">
            Foresight brings about desire and delight. It seeks to avoid assuming exceptions or responsibilities. In divisions, it acts with repudiation and denies any sense of necessity.
            </p>
          </div>
